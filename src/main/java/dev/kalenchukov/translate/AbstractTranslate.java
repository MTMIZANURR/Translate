 ...
 */
public abstract class AbstractTranslate implements Translating
{
	/**
	 * Стандарт.
	 */
	...
	/**
	 * Конструктор для {@code AbstractTranslate}.
	 *
	 * @param standard Стандарт.
	 */
	public AbstractTranslate(@NotNull final Standard standard)
	{
	...
	/**
	 * @see Translating#translate(String)
	 */
	@NotNull
	public String translate(@NotNull final String text)
	{
		...
		for (int position = 0; position < text.length(); position++) {
			translate.append(this.replacementSymbol(text, position));
		}
